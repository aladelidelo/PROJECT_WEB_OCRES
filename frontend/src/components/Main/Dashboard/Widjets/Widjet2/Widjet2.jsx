    ...
    var parseData = (bigData) => {
      ...
      bigData.forEach((e) => {
        if (e.yearOfRelease !== "N/A"&& e.type ==="movie") {
            ...
            else { boxOffice = parseInt(e.boxOffice);}
        ...
        <div className="graph">
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={this.data} margin={{ top: 30, right: 30, bottom: 30, left: 20 }}>
              <Line yAxisId="left" type='stepAfter' dataKey="moyenne" stroke="white" activeDot={{ r: 8 }} />
              ...
              <YAxis yAxisId="left" tick={{ fontSize: 12 }}>
                <Label value="boxOffice en millions de $" offset={-15} position="left" angle={-90} style={{ textAnchor: 'middle', fontSize: '80%', fill: 'rgba(255, 255, 255, 0.87)' }} />
              </YAxis>
