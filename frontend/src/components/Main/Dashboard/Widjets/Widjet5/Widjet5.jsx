          ...
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={this.data} margin={{ top: 30, right: 30, bottom: 30, left: 20 }}>
              ...
              <XAxis tick={{ fontSize: 12 }} size="1" dataKey="name" >
                <Label value="Langues" offset={-15} position="insideBottom" style={{ textAnchor: 'middle', fontSize: '80%', fill: 'rgba(255, 255, 255, 0.87)' }} />
              </XAxis>
              <YAxis yAxisId="left" tick={{ fontSize: 12 }}>
                <Label value="nombre de fois" offset={-15} position="left" angle={-90} style={{ textAnchor: 'middle', fontSize: '80%', fill: 'rgba(255, 255, 255, 0.87)' }} />
              </YAxis>
              <Tooltip />
            </ComposedChart>
          </ResponsiveContainer>
